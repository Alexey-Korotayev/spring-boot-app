package com.epam.springbootapp.services.responce;

import javax.ws.rs.core.Response;

public class ResponseCreator {

    public static Response error(int status, int errorCode, String description, String version) {
...
//        response.header("version", version);
        ...
        response.header("errordesc", description);
